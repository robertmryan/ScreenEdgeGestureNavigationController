//
//  RegistrationTwoViewController.m
...
#import "PredeterminedTwoViewController.h"

@interface PredeterminedTwoViewController ()

@property (nonatomic, weak) UIViewController *nextViewController;

@end

@implementation PredeterminedTwoViewController
...
// keep that instance of PredeterminedThreeViewController in memory, so if you push again
...
- (UIViewController *)nextViewController
{
    if (!_nextViewController) {
        UIViewController *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"PredeterminedThreeViewController"];
